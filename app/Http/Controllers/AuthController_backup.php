...
use Illuminate\S        // Asignar rol "paciente" (suponemos que el rol con id=4 es paciente)
        ...
        return redirect()->route('login')->with('status', 'Registro exitoso. Te hemos enviado un correo de bienvenida. Por favor inicia sesión.');rt\Facades\Hash;
